  ...
  render () {
    ...
    return (
      <div className='menu'>
        ...
        <MenuOption handleClick={this.handleClick} activePage={activePage} page='services' ico='directions_railway' title='Browse Services' /> 
        <MenuOption handleClick={this.handleClick} activePage={activePage} page='resources' ico='picture_as_pdf' title='Resources' /> 
